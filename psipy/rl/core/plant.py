...
from typing import Any, Callable, ClassVar, Dict, Generic, Mapping, Optional
...
class Plant(Generic[TState, TAction], metaclass=ABCMeta):
    ...
    Args:
        cost_function: Cost function that maps states to costs. If provided, will override
                       the cost coming from the plant
    """
